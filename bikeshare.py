...
def station_stats(df):
    ...
    print('The most frequent combination of start station and end station trip: Start Station - {}; End Station - {}\n'.format(common_start_station, common_end_station))
...
def view_raw_data(df):
    ...
    try:
        ...
        while True:
            ...
            # Displaying the next 5 lines of raw data at each iteration
